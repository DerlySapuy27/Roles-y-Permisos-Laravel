...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="nosotros" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Proyecto Prueba </span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="contacto" class="d-block">Yuderly Sapuy</a>
        </div>
      </div>
      <nav class="mt-2">
...
<!-- sweet alert -->
<script src="{{ asset('libs/Sweetalert2-11.4.34/dist/sweetalert2.all.min.js')}}"></script>
